<?php
  ...
  $strings['Use URL syntax (sso://hostname:port). If your server requires SSL, use ssos://hostname/ in this field.'] = 'Utilice la sintáxis de URL (sso://nombre_de_servidor:puerto). Si su servidor solicita SSL, utilice ssos://nombre_de_servidor/ en este campo';
  ...
  $strings['This should be the DN string for the OU containing the user list. For example, OU=People,OU=staff,DN=sso,DN=example,DN=com.'] = 'Esta prodría ser la cadena DN para el OU que contenga la lista de usuarios. Por ejemplo, OU=People, OU=staff,DN=sso,DN=example,DN=com.';
